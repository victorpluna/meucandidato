# Django settings for meucandidato project.
import os
...
SECRET_KEY = 'v)hc_@8%#$=^byq)o(96y*3fm4fl-5lapuslnxo!xy*f3oc8#6'
...
MIDDLEWARE_CLASSES = (
    ...
    'meucandidato.middleware.checarAutenticacao.checarAutenticacao',
    'fandjango.middleware.FacebookMiddleware',
    # Uncomment the next line for simple clickjacking protection:
    # 'django.middleware.clickjacking.XFrameOptionsMiddleware',
)

ROOT_URLCONF = 'meucandidato.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'meucandidato.wsgi.application'

TEMPLATE_DIRS = (
    "/home/victor/projetos/meucandidato/meucandidato/templates",
